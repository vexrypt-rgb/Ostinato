...
public final class BuilderProcess extends BaritoneProcessHelper implements IBuilderProcess {
    ...
    private final Function<Map.Entry<Property<?>, Comparable<?>>, PropertyContainer> PROPERTY_ENTRY_TO_STRING_FUNCTION = new Function<Map.Entry<Property<?>, Comparable<?>>, PropertyContainer>() {
    ...
    public void build(String name, ISchematic schematic, Vector3i origin) {
        ...
        this.schemSize = new Vector3i(schematic.widthX(), schematic.heightY(), schematic.lengthZ());
    ...
    public void popStack() {
        ...
        this.origin = (Vector3i) stateStack.pop();
